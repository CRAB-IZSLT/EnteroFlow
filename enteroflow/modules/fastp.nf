process FASTP {
	...
	fastp --in1 ${reads[0]} --in2 ${reads[1]} --out1 ${key}_trimm/"${key}_1_trim.fq.gz" --out2  ${key}_trimm/"${key}_2_trim.fq.gz" --thread ${params.threads} -q 25 
